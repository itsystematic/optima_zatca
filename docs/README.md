...
Documentation is organized **by domain**. Each folder has its own index. New to ZATCA? Start
with **[Concepts](concepts.md)**. For the product overview and installation, see the root
[README](../README.md).
...
| Area | For | Start here |
|------|-----|-----------|
| [Concepts & Glossary](concepts.md) | Everyone | [concepts.md](concepts.md) |
| [Setup](setup/) | Implementers & developers | [setup/](setup/README.md) |
| [Reference](reference/) | Developers | [architecture](reference/architecture.md) · [doctypes](reference/doctypes.md) |
