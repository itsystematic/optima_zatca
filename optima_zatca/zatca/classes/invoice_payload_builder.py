...
from optima_zatca.zatca.classes.invoice_context import LoadedInvoiceContext
...
""",
    ...
    def _add_invoice_type_data(self) -> None:
        ...
        pih, icv = get_invoice_counter_and_pih(invoice_type_info["EndPoint"], self.company_settings)
