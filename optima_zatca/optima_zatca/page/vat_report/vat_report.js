frappe.pages['vat_report'].on_page_load = function(wrapper) {
    ...
    // Add custom styles with black/gray/white + green/red color scheme
    $('head').append(`
        <style>
            .vat-report-page {
                padding: 20px;
            ...
            .refresh-btn {
                ...
                font-weight: 600;
                font-size: 16px;
                box-shadow: 0 5px 20px rgba(33, 37, 41, 0.4);
                transition: all 0.3s ease;
                color: white;
            }
            ...
            .refresh-btn:hover {
                ...
                box-shadow: 0 8px 25px rgba(33, 37, 41, 0.5);
                    ...
                    <div class="card header-card">
                        <div class="card-body">
                            <h3 class="header-title">
                                <i class="fa fa-line-chart"></i> VAT Report - Tax Analysis
                            </h3>
                ...
                <div class="row" style="margin-bottom: 30px;">
                    <div class="col-md-12">
                        <div class="card chart-container">
                            <div class="card-body">
                                <h4 style="text-align: center; color: #212529; margin-bottom: 30px; font-weight: 700;">
    ...
    // Initialize the page
    let vat_report = new VATReport(page);
};
...
class VATReport {
    ...
    load_tax_accounts(company) {
        frappe.call({
            method: 'optima_zatca.optima_zatca.page.vat_report.vat_report.get_tax_accounts',
            args: {
                company: company
            },
            callback: (r) => {
    ...
    refresh_data() {
        ...
        $('body').append(`
            <div class="loading-overlay" id="vat_loading">
                <div class="loading-spinner">
                    ...
                    <p style="margin-top: 20px; font-size: 16px; color: #212529; font-weight: 600;">
        ...
        frappe.call({
            method: 'optima_zatca.optima_zatca.page.vat_report.vat_report.get_vat_report_data',
            args: {
                company: company,
                from_date: from_date,
                to_date: to_date,
    ...
    render_summary_cards(summary) {
        const gradients = [
            ...
            'linear-gradient(135deg, #495057 0%, #adb5bd 100%)',
            'linear-gradient(135deg, #6c757d 0%, #ced4da 100%)',
            'linear-gradient(135deg, #212529 0%, #6c757d 100%)',
            'linear-gradient(135deg, #343a40 0%, #adb5bd 100%)'
        ];
        ...
        summary.forEach((item, index) => {
            ...
            let indicatorColor = item.indicator === 'green' ? '#28a745' : '#dc3545';
            let indicatorBg = item.indicator === 'green' ? '#d4edda' : '#f8d7da';
            let indicatorText = item.indicator === 'green' ? '#155724' : '#721c24';
            ...
            // Regular data row
                ...
                if (row.parenttype && row.name) {
                    name_link = `<a href="/app/${row.parenttype.toLowerCase().replace(/ /g, '-')}/${row.name}" 
                        target="_blank" style="color: #212529; font-weight: 600; text-decoration: none;">
